...
include 'db.php';
     ...
     if (isset ($_POST['fn'], $_POST['ln'], $_POST['tlf'], $_POST['epost'], $_POST['adresse'], $_POST['type'], $_POST['brukernavn'], $_POST['passord']) && !empty($_POST['fn'], $_POST['ln'], $_POST['tlf'], $_POST['epost'], $_POST['adresse'], $_POST['type'], $_POST['brukernavn'], $_POST['passord'])) {
		 $fornavn = $_POST['fn'];	   
		 $etternavn = $_POST['ln'];	   
         $tlf = $_POST['tlf'];	   
		 $epost = $_POST['epost'];
